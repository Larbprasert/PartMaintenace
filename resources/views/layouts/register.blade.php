...
<style>
    *:not(i){
    ...
    <body class=" login" style="    background-color: #e1e5ec !important;">
        <!-- BEGIN LOGO -->
        <!-- <div class="logo">
            <a href="{{ url('') }}">
                {{-- <img src="{{ url('backend/assets/pages/img/logo-big.png') }}" alt="" />  --}}
                <span class="login-logo" style="font-size: 3rem; color: #32c5d3;">Construction Material Management System</span>
        ...
        <!-- <div class="copyright"> 2019 © CMMS </div> -->
        <!--[if lt IE 9]>
